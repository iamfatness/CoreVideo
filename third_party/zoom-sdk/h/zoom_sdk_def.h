...
#if defined(WIN32)
/**
 * @brief Enumeration of SDK view type used by share controller.
 */
enum SDKViewType
{
    SDK_FIRST_VIEW = 0,
...
/**
 * @brief Zoom ratio when viewing a share.
 */
enum SDKShareViewZoomRatio
{
    SDKShareViewZoomRatio_FullPage = 0,
    SDKShareViewZoomRatio_25,
    SDKShareViewZoomRatio_50,
    SDKShareViewZoomRatio_75,
    SDKShareViewZoomRatio_100,
